...
In this assignment, let's build a Snake Game by applying the concepts we have learned so far.

#### Reference

[https://s3.ap-south-1.amazonaws.com/new-assets.ccbp.in/frontend/content/programming-foundations/updated%20project%20gifs/updated%20project%20gifs/snake.gif](https://s3.ap-south-1.amazonaws.com/new-assets.ccbp.in/frontend/content/programming-foundations/updated%20project%20gifs/updated%20project%20gifs/snake.gif)

#### Functionalities to be Achieved:

- Create a graphical user interface (GUI) for the snake game application.
- Implement game logic for snake movement, food spawning, scoring, and collision detection.
- Provide buttons to start, pause, and restart the game.
...
- **random:** For generating random positions for food spawning.
