...
In this assignment, let's build a Calculator application by applying the concepts we have learned so far.

#### Reference

[https://s3.ap-south-1.amazonaws.com/new-assets.ccbp.in/frontend/content/programming-foundations/updated%20project%20gifs/updated%20project%20gifs/claculator.gif](https://s3.ap-south-1.amazonaws.com/new-assets.ccbp.in/frontend/content/programming-foundations/updated%20project%20gifs/updated%20project%20gifs/claculator.gif)

#### Functionalities to be Achieved:

- Perform basic arithmetic operations such as addition, subtraction, multiplication, division, and percentage calculations.
- Enable advanced scientific operations like trigonometric functions, logarithms, square root, factorial, and exponentiation.
- Provide memory operations, including clearing, adding, subtracting, and recalling memory values.
- Handle constants like Pi (π) and Euler's number (e) for calculations.
- Ensure robust error handling and dynamic input/output display updates.
